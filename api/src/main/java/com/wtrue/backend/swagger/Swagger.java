package com.wtrue.backend.swagger;
...
public class Swagger {
    ...
    public Docket swaggerDocket(){
        ...
        SwaggerConfig swagger = SwaggerConfig.builder().title(title).contact(contact).description(description).version(version).url(web).build();
